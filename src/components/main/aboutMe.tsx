    ...
    <section className="w-full py-4 px-6 border-t border-gray-700 ">
      <div className="relative">
        ...
        <section className="flex flex-col space-y-6">
          ...
          <div className="w-full p-0 custom:p-6 border border-opacity-0 custom:border-opacity-100 border-gray-700 rounded-2xl mt-4 backdrop-blur-sm transition-all duration-300 hover:shadow-xl hover:shadow-gray-800/10">
            <Skill />
          </div>
        </section>
      </div>
