...
export const Project = () => {
  const projects: ProjectData[] = [
    ...
    {   
      ...
      notionLink: "https://indigo-sprite-bd5.notion.site/Grim-talk-1eb4ba04719a80e2a9def38ccb594ae2",
    ...
    },
    {
      ...
      notionLink: "https://indigo-sprite-bd5.notion.site/MOODFLEX-1eb4ba04719a808a8cd3d3f84fb86d24",
      thumbnail: MoodFlex,
      position: "FrontEnd",
    },
  ];
